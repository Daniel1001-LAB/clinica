                ...
                <li class="active">
                    <a href="{{ url('dash') }}" class="menu-toggle" data-active="true">
                        <div class="base-menu">
                            ...
                            <span class="text-capitalize">{{ __('dashboard') }}</span>
                        </div>
                    </a>
                </li>
            @endcan
            ...
            <li class="">
                <a href="{{ url('pos') }}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        ...
                        <span class="text-capitalize">{{ __('sales') }}</span>
                    </div>
                </a>
            </li>
                ...
                <li class="">
                    <a href="{{ url('roles') }}" class="menu-toggle" data-active="false">
                        <div class="base-menu">
                            ...
                            <span class="text-capitalize">{{ __('roles') }}</span>
                        </div>
                    </a>
                </li>
            @endcan
                ...
                <li class="">
                    <a href="{{ url('permissions') }}" class="menu-toggle" data-active="false">
                        <div class="base-menu">
                            ...
                            <span class="text-capitalize">{{ __('permissons') }}</span>
                        </div>
                    </a>
                </li>
            @endcan
                ...
                <li class="">
                    <a href="{{ url('asignar') }}" class="menu-toggle" data-active="false">
                        <div class="base-menu">
                            ...
                            <span class="text-capitalize">{{ __('assign') }}</span>
                        </div>
                    </a>
                </li>
            @endcan
            ...
            <li class="">
                <a href="{{ url('coins') }}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        ...
                        <span class="text-capitalize">{{ __('coins') }}</span>
                    </div>
                </a>
            </li>
            <li class="">
                <a href="{{ url('cashout') }}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        ...
                        <span class="text-capitalize">{{ __('closures') }}</span>
                    </div>
                </a>
            </li>
            <li class="">
                <a href="{{ url('reports') }}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        ...
                        <span class="text-capitalize">{{ __('reports') }}</span>
                    </div>
                </a>
            </li>
