            ...
            <tr>
                <td>
                                                            ...
                                                            <td class="pad">
                                                                <div align="left" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        src="{{ asset('assets/7417c70e-68fd-48fb-a7d9-c61ef28bcf6e.png') }}"
                                                                        style="display: block; height: auto; border: 0; width: 590px; max-width: 100%;"
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d9dffa; background-image: url('{{ asset('assets/body_background_2.png') }}'); background-position: top center; background-repeat: repeat;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <strong><span
                                                                                    style="font-size:38px;">Notificación
                                                                                    de Cita</span></strong>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            <span style="font-size:16px;">Hola,
                                                                                {{ $notifiable->name }}
                                                                            </span>has sido notificado sobre una
                                                                            cita programada para el día {{ $appoinment->date }}.
                                                                        </p>
                                                                        <br>
                                                                        <p
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 19.2px;">
                                                                            Por favor, confirma tu asistencia o
                                                                            comunícate con nosotros si necesitas
                                                                            cancelarla.</p>
                                                                        <br>
                                                                            <p
                                                                            style="margin: 0; mso-line-height-alt: 16.8px;">
                                                                        ...
                                                                        <br>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 19.2px; color:#506bec">
                                                                            Consultorio:
                                                                            {{ $appoinment->office->local }}</p>
                                                                            <br>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 19.2px; color:#506bec">
                                                                            Hora: {{ $appoinment->hour }}</p>
                                                                            <br>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 19.2px; color:#506bec">
                                                                            Hora: {{ $appoinment->date }}</p>
                                                                            <br>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 19.2px; color:#506bec">
                                                                            Doctor: {{ $appoinment->doctor->name }}</p>
                                                                            <br>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
                                                                            <span style="font-size:14px;">Tienes
                                                                                problemas? <a
                                                                                    href="mailto:edwindaniel.merinopaz@gmail.com"
                                                                                    rel="noopener"
                                                                                    style="text-decoration: none; color: #40507a;"
                                                                                    target="_blank"
                                                                                    title="@socialaccount"><strong>edwindaiel.merinopaz@gmail.com</strong></a></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        class="big"
                                                                        src="{{ asset('assets/bottom_img.png') }}"
                                                            ...
                                                            <td class="pad">
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a
                                                                        href="https://www.uaps-sanluis.com/"
                                                                        style="outline:none" tabindex="-1"
                                                                        target="_blank"><img alt="Your Logo"
                                                                            src="{{ asset('assets/87b375a9-d9d6-426d-a26e-3166f2509f1d.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 116px; max-width: 100%;"
                                                                            title="Your Logo" width="116" /></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                    ...
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0 2px 0 2px;"><a
                                                                                    href="https://www.instagram.com/danieel_1001/?hl=es-la"
                                                                                    target="_blank"><img
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            Copyright© 2023 EMERINO - UAPS - SAN LUIS
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
