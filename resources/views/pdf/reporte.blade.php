		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td colspan="2" class="text-center">
					<span style="font-size: 25px; font-weight: bold;">Sistema UAPS-POS San Luis Planes</span>
				</td>
			</tr>
			<tr>
				<td width="30%" style="vertical-align: top; padding-top: 10px; position: relative">
					<img class="img-rounded" src="{{ asset('assets/onlyLogov1.svg') }}" style="background: white" alt="" class="invoice-logo">
				</td>
