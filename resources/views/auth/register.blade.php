    ...
    <div class="h-screen md:flex">
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form class="bg-white" method="POST" action="{{ route('register') }}">
                ...
                @csrf
                <div class="mb-3">
                    <x-input label="{{ __('Name') }}" id="name" name="name" icon="user"
                        placeholder="{{ __('your name') }}" :value="old('name')" required autofocus autocomplete="name" />
                </div>
                <div class="mb-3">
                    <x-input label="{{ __('Email') }}" icon="at-symbol" id="email" class="block mt-1 w-full"
                        placeholder="{{ __('your email') }}" type="email" name="email" :value="old('email')" required
                        autocomplete="username" />
                </div>
                <div class="mb-3">
                    <x-inputs.password label="{{ __('Password') }}" id="password" class="block mt-1 w-full"
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <x-button primary spinner class="ml-4" type="submit">
                        {{ __('Register') }}
                    </x-button>
                </div>
            </form>
