<div class="antialiased bg-gray-200">
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div>
                <h2 class="text-2xl capitalize font-semibold leading-tight">{{ __('LISEM health program') }}</h2>
            </div>
            <div class="my-2 flex sm:flex-row flex-col">
                <div class="flex flex-row mb-1 sm:mb-0 justify-center">
                    ...
                    <div class="flex justify-between items-center capitalize">
                        ...
                        <x-button wire:click="$set('modal', 'true')" label="{{ __('add') }}" flat primary
                            icon="plus"></x-button>
                    </div>
            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                            ...
                            <tr>
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-10 h-10">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="text-blue-400">
                                ...
                                <td width="10%" class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div class="flex sm:flex-wrap justify-end items-center gap-1">
                                        <x-button.circle spinner="edit" loading-delay="short" primary icon="pencil" />
                                        <x-button.circle spinner="delete" loading-delay="short" negative
                                            icon="trash" />
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="px-5 py-5 bg-white border-t items-center ">
    ...
    {{-- Modal Crear --}}
    <x-modal.card title="{{ __('add disase') }}" blur wire:model="modal">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <x-input wire:model="name" label="{{ __('Name') }}" placeholder="{{ __('name of the disase..') }}" />

            <div class="col-span-1 sm:col-span-2">
                <x-textarea id="new" wire:model="symptoms" label="{{ __('symptoms') }}"
                    placeholder="{{ __('Describe the symtoms of the disase...') }}" />
        ...
        <x-slot name="footer">
            <div class="flex justify-end gap-x-4">
                <div class="flex">
                    ...
                    <x-button primary label="{{ __('create') }}" wire:click="addDisase" />
                </div>
            </div>
        </x-slot>
    </x-modal.card>
    ...
    {{-- Modal Editar --}}
    <x-modal.card title="{{ __('edit disase') }}" blur wire:model="modalEdit">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="col-span-1 sm:col-span-2">
                <x-badge flat lg primary label="Doc: {{ auth()->user()->name }}" />
            </div>
            ...
            <x-input wire:model="name" label="{{ __('Name') }}"
                placeholder="{{ __('name of the disase..') }}" />

            <div class="col-span-1 sm:col-span-2">
                <x-textarea id="edit2" wire:model="symptoms" label="{{ __('symptoms') }}"
                    placeholder="{{ __('Describe the symtoms of the disase...') }}" />
        ...
        <x-slot name="footer">
            <div class="flex justify-end gap-x-4">
                <div class="flex">
                    ...
                    <x-button spinner="update" loading-delay="short" primary icon="check"
                        label="{{ __('update') }}" />
                </div>
            </div>
        </x-slot>
