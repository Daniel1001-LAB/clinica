<div class="antialiased bg-gray-200">
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div>
                <h2 class="text-2xl capitalize font-semibold leading-tight">{{ __('disases') }}</h2>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td width="10%" class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex sm:flex-wrap justify-end items-center gap-1">
                                            <x-button.circle spinner="edit" loading-delay="short" wire:click="edit({{$disase->id}})" primary icon="pencil" />
                                            <x-button.circle spinner="delete" loading-delay="short" wire:click="delete({{$disase->id}})" negative icon="trash" />
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
        ...
        <x-slot name="footer">
            <div class="flex justify-end gap-x-4">
                <div class="flex">
                    ...
                    <x-button spinner="update" loading-delay="short"  primary icon="check" label="{{ __('update') }}" wire:click="update({{$disaseId}})" />
                </div>
            </div>
        </x-slot>
    </x-modal.card>
