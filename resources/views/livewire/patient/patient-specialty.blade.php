        ...
        <div class="container mx-auto px-4 mt-2 p-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <div class="col-span-1 lg:col-span-4 text-left md:text-center">
                    <h3 class="text-black text-5xl capitalize">{{ __('our specialties') }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="w-full">
            <form class="flex items-center">
                ...
                <div class="relative w-full">
                    ...
                    <input wire:model="search" placeholder="{{ __('find specialties') }}" type="text"
                        id="simple-search"
                    ...
                    <div class="mt-4 max-h-32 overflow-y-auto">
                        ...
                        @if (count($specialty->doctors) > 0)
                            @foreach ($specialty->doctors as $doctor)
                                <div class="flex items-center mb-2 cursor-pointer" wire:click="selectDate({{$doctor->id}} , {{$specialty->id}})">
