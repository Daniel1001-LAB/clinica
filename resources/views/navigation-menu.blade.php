@php($navLinks = [['name' => 'roles', 'route' => route('roles.index'), 'active' => request()->routeIs('roles.index')], ['name' => 'users', 'route' => route('users.index'), 'active' => request()->routeIs('users.index')], ['name' => 'specialties', 'route' => route('specialties.index'), 'active' => request()->routeIs('specialties.index')]])

<nav id="navi" x-data="{ open: false }" class="bg-white border-b border-gray-100">
