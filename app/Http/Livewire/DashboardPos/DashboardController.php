...
namespace App\Http\Livewire\DashboardPos;
...
class DashboardController extends Component
{
    ...
    public $salesByMonth_Data = [], $year, $listYears = [], $top5Data = [], $weekSales_Data = [], $sales = [];
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard-pos.dashboard-controller', [])->extends('inventory.app')->section('content');
    }
