...
class UsersController extends Component
{
    ...
    public function Store()
    {
        ...
        if ($this->image) {
            ...
            $this->image->storeAs('public/profile-photos', $customFileName);
            $user->profile_photo_path = $customFileName;
            $user->save();
        }
    ...
    public function Update()
    {
        ...
        if ($this->image) {
            ...
            if ($imageTemp != null) {
                if (file_exists('storage/profile-photos/' . $imageTemp)) {
                    unlink('storage/profile-photos/' . $imageTemp);
                }
            }
        }
