...
class ReportsController extends Component
{
    ...
    public $componentName, $pageTitle, $data, $details, $sumDetails, $countDetails, $reportType, $userId, $dateFrom, $dateTo
    , $saleId;
    ...
    {
        $this->SalesByDate();
        return view('livewire.reports.reports-controller',[
            'users' => User::orderBy('name', 'asc')->get()
        ])->extends('inventory.app')->section('content');
    }

    public function SalesByDate(){
        if($this->reportType == 0){ //Reportes del dia
    ...
    public function getDetails($saleId){
        ...
        ->select('sale_details.*', 'sale_details.price', 'sale_details.quantity', 'p.name as product')
        ...
        $this->emit('show-modal', 'Details loades');
